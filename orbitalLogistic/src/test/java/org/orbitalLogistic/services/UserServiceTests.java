...
class UserServiceTests {
    ...
    void registerUser_WithValidRequest_ShouldCreateUser() {
        ...
        UserResponseDTO expectedResponse = new UserResponseDTO(
                1L, "jane.doe@example.com", "Jane", "USER"
        );
    ...
    void getUsers_WithValidFilters_ShouldReturnPageResponse() {
        ...
        verify(userRepository, times(1)).findUsersWithFilters("john.doe@example.com", "John", 10, 0);
        verify(userRepository, times(1)).countUsersWithFilters("john.doe@example.com", "John");
    }
    ...
    void updateUser_WithValidId_ShouldUpdateUser() {
        ...
        UserResponseDTO updatedResponse = new UserResponseDTO(
                1L, "john.doe@example.com", "Jane Updated", "USER"
        );
